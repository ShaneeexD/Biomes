...
public class BiomeDangerWoods extends Biome
{
    ...
    public BiomeDangerWoods(BiomeTaiga.Type typeIn, Biome.BiomeProperties properties)
    {
        super(properties);
        this.type = typeIn;
        ...
        this.spawnableMonsterList.add(new Biome.SpawnListEntry(EntityCustomVindicator.class, 80, 2, 3));
      //  this.spawnableMonsterList.add(new Biome.SpawnListEntry(EntityIllusionIllager.class, 10, 1, 1));
