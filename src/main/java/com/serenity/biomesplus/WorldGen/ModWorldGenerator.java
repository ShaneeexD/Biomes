...
public class ModWorldGenerator extends WorldGenerator implements IWorldGenerator {
	...
	public static final SubWorldGen VINDICATOR_HOUSE = new SubWorldGen();
	public static final GenDoubleHouse DOUBLE_HOUSE = new GenDoubleHouse();
static Random rand2 = new Random();
	...
	public void generate(Random rand, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator,
		...
		switch (world.provider.getDimension())
		{
			...
			//	generateOverworld(world, rand, blockX + 8, blockZ + 8);
				generateStructure(VINDICATOR_HOUSE, world, rand, chunkX, chunkZ, 20, Blocks.GRASS, BiomeDangerWoods.class);
				generateStructure(DOUBLE_HOUSE, world, rand, chunkX, chunkZ, 20, Blocks.GRASS, BiomeSnow.class);
				break;
			case 1: 
	...
	private void generateOverworld(World world, Random rand, int blockX, int blockZ, Class<?>... classes)
	{	
		if ((int) (Math.random() * 100) == 1f)
		{
