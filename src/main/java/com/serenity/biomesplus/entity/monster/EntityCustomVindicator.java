...
public class EntityCustomVindicator extends AbstractIllager
{
    ...
    public EntityCustomVindicator(World worldIn)
    {
        super(worldIn);
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityCustomVindicator.class);
    }
    ...
    protected void initEntityAI()
    {
        ...
        this.targetTasks.addTask(1, new EntityAIHurtByTarget(this, true, new Class[] {EntityCustomVindicator.class}));
        this.targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, EntityPlayer.class, true));
        this.targetTasks.addTask(3, new EntityAINearestAttackableTarget(this, EntityVillager.class, true));
        this.targetTasks.addTask(3, new EntityAINearestAttackableTarget(this, EntityIronGolem.class, true));
        this.targetTasks.addTask(4, new EntityCustomVindicator.AIJohnnyAttack(this));
    }
    ...
    {
        return LootTableHandler.CUSTOM_VINDICATOR;
    }
    ...
    static class AIJohnnyAttack extends EntityAINearestAttackableTarget<EntityLivingBase>
        {
            public AIJohnnyAttack(EntityCustomVindicator entityCustomVindicator)
            {
                super(entityCustomVindicator, EntityLivingBase.class, 0, true, true, EntityCustomVindicator.JOHNNY_SELECTOR);
            }
            ...
            {
                return ((EntityCustomVindicator)this.taskOwner).johnny && super.shouldExecute();
            }
        }
}