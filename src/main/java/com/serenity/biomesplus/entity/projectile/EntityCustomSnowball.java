package com.serenity.biomesplus.entity.projectile;
...
public class EntityCustomSnowball extends EntityThrowable
{
    ...
    {
        EntityThrowable.registerFixesThrowable(fixer, "custom_snowball");
    }
